...
//---------------------------------------------------------------------
FORCE_INLINE static void memcpy_sse2_16(void *dst, const void *src) {
    __m128i m0 = _mm_loadu_si128(((const __m128i*)src) + 0);
    _mm_storeu_si128(((__m128i*)dst) + 0, m0);
}
FORCE_INLINE static void memcpy_sse2_32(void *dst, const void *src) {
    __m128i m0 = _mm_loadu_si128(((const __m128i*)src) + 0);
    __m128i m1 = _mm_loadu_si128(((const __m128i*)src) + 1);
    _mm_storeu_si128(((__m128i*)dst) + 0, m0);
    _mm_storeu_si128(((__m128i*)dst) + 1, m1);
}
FORCE_INLINE static void memcpy_sse2_64(void *dst, const void *src) {
    __m128i m0 = _mm_loadu_si128(((const __m128i*)src) + 0);
    __m128i m1 = _mm_loadu_si128(((const __m128i*)src) + 1);
...
FORCE_INLINE static void memcpy_sse2_128(void *dst, const void *src) {
    __m128i m0 = _mm_loadu_si128(((const __m128i*)src) + 0);
    __m128i m1 = _mm_loadu_si128(((const __m128i*)src) + 1);
    __m128i m2 = _mm_loadu_si128(((const __m128i*)src) + 2);
    __m128i m3 = _mm_loadu_si128(((const __m128i*)src) + 3);
...
//---------------------------------------------------------------------
FORCE_INLINE static void *memcpy_tiny(void *dst, const void *src, size_t size) {
    ...
    switch (size) {
        ...
        case 8:
            *((ulonglong*)(dd - 8)) = *((ulonglong*)(ss - 8));
            break;

        case 73:
            memcpy_sse2_64(dd - 73, ss - 73);
        case 9:
            *((ulonglong*)(dd - 9)) = *((ulonglong*)(ss - 9));
            dd[-1] = ss[-1];
            break;
        ...
        case 10:
            *((ulonglong*)(dd - 10)) = *((ulonglong*)(ss - 10));
            *((ushort*)(dd - 2)) = *((ushort*)(ss - 2));
            break;
        ...
        case 11:
            *((ulonglong*)(dd - 11)) = *((ulonglong*)(ss - 11));
            *((uint*)(dd - 4)) = *((uint*)(ss - 4));
            break;
        ...
        case 12:
            *((ulonglong*)(dd - 12)) = *((ulonglong*)(ss - 12));
            *((uint*)(dd - 4)) = *((uint*)(ss - 4));
            break;
        ...
        case 13:
            *((ulonglong*)(dd - 13)) = *((ulonglong*)(ss - 13));
            *((uint*)(dd - 5)) = *((uint*)(ss - 5));
            dd[-1] = ss[-1];
            break;
        ...
        case 14:
            *((ulonglong*)(dd - 14)) = *((ulonglong*)(ss - 14));
            *((ulonglong*)(dd - 8)) = *((ulonglong*)(ss - 8));
            break;
        ...
        case 15:
            *((ulonglong*)(dd - 15)) = *((ulonglong*)(ss - 15));
            *((ulonglong*)(dd - 8)) = *((ulonglong*)(ss - 8));
            break;
...
static void* SuperFastMemCpy(void *destination, const void *source, size_t size)
{
    unsigned char *dst = (unsigned char*)destination;
    const unsigned char *src = (const unsigned char*)source;
    size_t cachesize = 0x200000; // L2-cache size
    size_t padding;
...
TEST(ALLOCtEST, TEST_ALLOC_DEALLOC)
{
    ...
    for (int j = 0; j <= 1512; j++)
    {
        ...
        int i;
        if (intptr != NULL)
            //SuperFastMemCpy(intptr, &mod, j); //4500ms
