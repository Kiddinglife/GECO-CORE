...
iterator_category(const input_iterator<Type, Distance>&)
{
...
iterator_category(const forward_iterator<Type, Distance>&)
{
...
iterator_category(const bidirectional_iterator<Type, Distance>&)
{
...
iterator_category(const random_access_iterator<Type, Distance>&)
{
...
template <class Type>
inline Type* value_type(const Type*) { return (Type*)(0); }
...
template <class Type>
inline ptrdiff_t* distance_type(const Type*) { return (ptrdiff_t*)(0); }
...
inline void __distance(InputIter first, InputIter last, Distance& n, input_iterator_tag)
{
    while (__first != __last) { ++__first; ++n; }
}
...
template <class InputIter, class Distance>
inline void distance(InputIter __first,
    InputIter __last, Distance& n)
{
...
inline typename iterator_traitor<InputIter>::difference_type
__distance(InputIter __first, InputIter __last, input_iterator_tag)
{
...
inline typename iterator_traitor<_RandomAccessIterator>::difference_type
