...
#       error unimplemented
    ...
    void acquire()
    {
        ...
        unsigned __my_spin_max = spin_vals_t::__max;
        unsigned __my_last_spins = spin_vals_t::__last;
        ...
        for (__i = 0; __i < __my_spin_max; __i++)
        {
            ...
            if (!refc_.swap(1))
            {
                ...
                // 
                spin_vals_t::__last = __i;
                spin_vals_t::__max = spin_vals_t::__high_max;
                return;
            }
        }
        ...
        spin_vals_t::__max = spin_vals_t::__low_max;
        for (__i = 0;; ++__i)
        {
